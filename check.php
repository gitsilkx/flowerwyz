                ...
                <link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
                    ...
                    <script>
                    	function myclick(w)
						{
							switch(w)
							{
								case 1: $('#collapseTwo, #collapseThree, #collapseFour').collapse('hide');
								case 2: $("#collapseOne, #collapseThree, #collapseFour").collapse('hide');
								case 3: $("#collapseOne, #collapseTwo, #collapseFour").collapse('hide');
								case 4: $("#collapseOne, #collapseTwo, #collapseThree").collapse('hide');
							}
						}
						function collFunction2()
						{
							document.getElementById("panel2").href='#collapseTwo';
							$("#collapseOne").collapse('hide');
							$("#collapseTwo").collapse('show');
							//alert("ok");
						}
						function collFunction3()
						{
							var inp = $("#rname");
							if (inp.val().length > 0) {
								document.getElementById("panel3").href='#collapseThree';
						...
						function collFunction4()
						{
							document.getElementById("panel4").href='#collapseFour';
                            ...
                            <div style="background:#ffeaeb; padding:10px 0 0 5%; overflow:hidden; width:90%">
                                ...
                                <div>
                                    ...
                                    <div style="width:70%; float:left;">
                                        ...
                                        <form class="cmxform" method="post" action="<?= $vpath; ?>notify.php">
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne" style="background: #e97d94; padding:8px 0px; font-size:16px; height:auto">
      <h4 class="panel-title">
        <a onclick="myclick(1)" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          Review Cart
        </a>
      </h4>
    </div>
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        ...
        <button class="btn btn-primary pull-right" onclick="collFunction2()">
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingTwo" style="background: #e97d94; padding:8px 0px; font-size:16px; height:auto">
      <h4 class="panel-title">
        <a onclick="myclick(2)" id="panel2" class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="false" aria-controls="collapseTwo">
    ...
    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div class="panel-body">
        <fieldset id="frmRecip">
                                            <div class="row">
                                                  <div class="col-sm-6">
                                                    <div class="form_sep">

                                                        <input id="rname" name="rname" placeholder="Name*" type="text" class="form-control" required>
                                                    </div>
                                                    <div class="form_sep">
                                                    ...
                                                    <div class="form_sep">
                                                        ...
                                                        <input id="raddress1" name="raddress1" type="text" placeholder="Address*" class="form-control" required>
                                                    </div>
                                                    <div class="form_sep">
        ...
        <div class="clearfix"></div>  
          ...
          <button class="btn btn-primary pull-right" onclick="collFunction3()">
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingThree" style="background: #e97d94; padding:8px 0px; font-size:16px; height:auto">
      <h4 class="panel-title">
        <a onclick="myclick(3)" id="panel3" class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="false" aria-controls="collapseThree">
          Billing Information
        </a>
      </h4>
    </div>
    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
      <div class="panel-body">
        ...
        <div class="clearfix"></div>                                
        <button class="btn btn-primary pull-right" onclick="collFunction4()">
  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingFour" style="background: #e97d94; padding:8px 0px; font-size:16px; height:auto">
      <h4 class="panel-title">
        <a onclick="myclick(4)" id="panel4" class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="false" aria-controls="collapseFour">
          Payment Methods
        </a>
      </h4>
    </div>
