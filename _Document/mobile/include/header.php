...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
        ...
        <link rel="stylesheet" href="<?= $vpath ?>css/slicknav.css" />
        ...
        <div id="Container">
            <div id="header">
                <div class="h_top">
                   <div class="innerWrap">
                       <div class="t-Txt">
                            <h3>Online Flowers Delivery | Send Flowers Online | Cheap Flower Delivery</h3>
                            <div class="cboth"></div>
                        </div>
                        <div class="t-TxtRight">
                            <h3>** Order Before 1.00PM Recipient Time for Same Day.</h3>
                            <div class="cboth"></div>
                        </div>
                   </div>
                                                ...
                                                <div class="header-serch-container">
                                                    <div class="header-search">
                                                        ...
                                                        <div class="search_sec">
                                                            <button type="submit" class="spl_btn">Search <img src="images/header_search.png" alt=""></button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row-fluid mainNavBg">
                                                    ...
                                                    <div id="Menu"><ul><li class="First ActivePage"><a href="<?= $vpath ?>"><span>Home</span></a></li>
                                                            ...
                                                            <li class="HasSubMenu ">
                                                                ...
                                                                <a href="<?= $vpath ?>"><span>Floral Delivery</span></a>
                                                         ...
                                                         <li><a href="<?= $vpath ?>index.htm">Same Day Flowers</a></li>
                                                                ...
                                                                <a href="<?= $vpath ?>"><span>plant delivery</span></a>



                                                            </li>   <li class=" ">

                                                                <a href="<?= $vpath ?>"><span>Flower Bouquets</span></a>



                                                            </li>   <li class=" ">

                                                                <a href="<?= $vpath ?>"><span>Discount Flowers</span></a>



                                                            </li>   <li class=" ">

                                                                <a href="<?= $vpath ?>"><span>Wholesale Flowers</span></a>



                                                            </li>   <li class=" ">

                                                                <a href="<?= $vpath ?>"><span>Exotic Flowers</span></a>



                                                            </li>   <li class=" ">
                                                                <a href="<?= $vpath ?>"><span>Flower Shops</span></a>
                                                            </li>
                                                            <li class=" ">
                                                                <a href="<?= $vpath ?>"><span>Order Flowers</span></a>
                                                            </li>
