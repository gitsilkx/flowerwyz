...
if (isset($_GET['pg_id'])) {
    ...
    if ($header_page_id == '37') { //Home
        ...
        $head_prm1 = 'Discount Flowers | Flower Deals and Flower Coupons | Inexpensive Flowers | Affordable Flowers';
        $head_prm2 = 'SEND';
        $head_prm3 = 'SAME DAY **';
        ...
        $head_prm1 = 'Online Flower Shops & Flower Stores | Online Florists FlowerShops | Florist Delivery';
        $head_prm2 = 'SEND';
        $head_prm3 = 'SAME DAY **';
        $head_prm4 = 'FLOWER SHOPS DELIVERY';
        $footer_content = 'FlowerWyz | Online Flower Shops & Flower Stores | Online Florists FlowerShops | Florist Delivery.';
        $page_title = 'FlowerWyz Online Flower Shops & Flower Stores | Online Florists FlowerShops | Florist Delivery';
        $meta_description = 'Looking for Florist Delivery from Online Flower Shops that Deliver? Check out FlowerWyz Flower Store. Accredited Online Florists for Best Flowershops Deliveries. Call us Today!';
        $meta_keywords = 'flower shop,flower shops,flower store,flowes,online florist,floral shop,flowers shop,flower stores,the flower shop,flowershop,florist delivery,florist shop,flowers shops,online florists,florist online,best online florist';
        ...
        $head_prm1 = 'Sympathy Flowers | Sympathy Baskets | Condolence Flowers | Sympathy Gift Baskets and Ideas Online';
        $head_prm2 = 'SEND';
        $head_prm3 = 'SAME DAY **';
        ...
        $head_prm1 = 'Plant Delivery | Send a Plant as Gift | Send House Plant Gifts';
        $head_prm2 = 'SEND';
        $head_prm3 = 'SAME DAY ** ';
        $head_prm4 = 'PLANT DELIVERY';
        $footer_content = 'FlowerWyz | Plant Delivery | Send a Plant as Gift | Send House Plant Gifts.';
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
        ...
        <link href="<?= $vpath ?>css/responsive.css" rel="stylesheet" type="text/css" />
           <link href="<?= $vpath ?>css/mobile_style.css" rel="stylesheet" type="text/css" />
       <!-- <link href="<//?= $vpath ?>css/mobile_responsive.css" rel="stylesheet" type="text/css" />-->
        <link href="<?= $vpath ?>css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= $vpath ?>css/bootstrap-theme.min.css" rel="stylesheet" type="text/css" />
        
        <link rel="stylesheet" href="<?= $vpath ?>css/skin.css" />
        <link rel="stylesheet" href="<?= $vpath ?>css/Arvo.css" />
        <link rel="stylesheet" href="<?= $vpath ?>css/Lato.css" />
        <link rel="stylesheet" href="<?= $vpath ?>css/OpenSans.css" />
        <link rel="stylesheet" type="text/css" href="<?= $vpath ?>css/splay.css"/>

        <script  type="text/javascript" src="<?= $vpath ?>js/jquery.js"></script>
         <script  type="text/javascript" src="<?= $vpath ?>js/bootstrap.min.js"></script>
                                            ...
                                            <div class="h_contacts">
                                                ...
                                                <div class="header-serch-container">
                                                    <div class="header-search">
                                                        ...
                                                        <input type="text" name="code" placeholder="Keyword or Product No." value="<?php if (isset($_GET['code'])) echo $_GET['code']; ?>"  class="florist_log" />

                                                        <div style="margin-left: 33%; margin-top: 8px;margin-bottom: -5px;width:100%;">
                                                            <button type="submit" class="spl_btn">SEARCH</button>
                                                        </div>
                                                    </div>
