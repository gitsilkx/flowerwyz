...
if (isset($_GET['pg_id'])) {
	...
	if ($header_page_id == '37') { //Home
		...
		$meta_keywords = 'flower delivery, send flowers, flowers online, flowers delivery, online flowers, online flower delivery, cheap flower delivery, send flowers online, order flowers online, buy flowers online, sending flowers online, best flower delivery, flower online, cheap flowers online, online flowers delivery, flowers online delivery';
	} elseif ($header_page_id == '4') { // Today
		$page_content = 'today_content.php';
		$head_prm1 = 'Same Day Flower Delivery | Same Day Delivery Flowers Delivered Today | Same Day Flowers';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Next Day Flower Delivery | Next Day Delivery Flowers Delivered Tomorrow | Next Day Flowers';
		$head_prm2 = 'SEND';
		$head_prm3 = 'NEXT DAY **';
		...
		$head_prm1 = 'Discount Flowers | Flower Deals and Flower Coupons | Inexpensive Flowers Free Delivery';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'DISCOUNT FLOWER DEALS';
		$page_title = 'FlowerWyz Discount Flowers | Flower Deals and Flower Coupons | Inexpensive Flowers Free Delivery';
		$meta_description = 'Looking for Great Flower Deals and Flower Coupons? Check out FlowerWyz Discount Flowers Delivery Service. You can order Free Flowers Free Delivery for Same or Next Day Delivery. Call us Today!';
		$meta_keywords = 'discount flowers, flower coupons, flowers free delivery, free flower delivery, flower deals, flowers discount, free delivery flowers, inexpensive flowers, flower delivery coupons, affordable flowers, flowers online free delivery, flowers free shipping, discount flower delivery, flowers with free delivery, inexpensive flower delivery, affordable flower delivery';
		...
		$head_prm1 = 'Cheap Flower Arrangements Ideas | Online Flower Shops and Flower Stores';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER ARRANGEMENTS';
		$page_title = 'FlowerWyz Cheap Flower Arrangements Ideas | Online Flower Shops and Flower Stores';
		$meta_description = 'Looking for Cheap Flower Arrangements Ideas from the best Online Flower Shops? Check out FlowerWyz Flower Stores. Accredited Flower Shops Online for Same or Next Day Delivery Service. Call us Today!';
		$meta_keywords = 'flower shop, flower arrangements, flower shops, flower store, flowes, flower arrangement, flowers arrangements, flowers shop, flower stores, the flower shop, flowershop, flower arrangements ideas, flowers shops, cheap flower arrangements, modern floral arrangements, flowershops';
		...
		$meta_description = 'Looking TO Order Flowers Online for Delivery? Learn Where to Buy Flowers Online at FlowerWyz. Accredited Same or Next Day Delivery Service. Call us Today!';
		$meta_keywords = 'order flowers, order flowers online, buy flowers online, buy flowers, ordering flowers, where to buy flowers, order flowers online for delivery, order flowers online cheap, ordering flowers online, flowers order, flowers to order, flower order, order flowers cheap, order flowers for delivery, online flower order, buying flowers online';
	} elseif ($header_page_id == '1') { //ANNIVERSARY
		$page_content = 'anniversary_content.php';
		$head_prm1 = 'Wedding Anniversary Gifts | Anniversary Flowers for Anniversary Gift Ideas and Baskets';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Birthday Flowers Delivery | Birthday Gift Baskets | Birthday Gifts for Mom | Birthday Delivery Ideas';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Sympathy Flowers Delivery | Sympathy Gift Baskets | Flowers for Sympathy Online';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Valentines Day Flowers | Valentines Flowers Delivery | Valentine Flowers | Valentine Gift Baskets';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Get Well Gift Baskets | Buy Get Well Flowers Delivery';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Fresh Cut Flowers Online | Order Fresh Flower Delivery | Fresh Flowers Wholesale';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Local Flower Delivery | Local Flowers from Local Florists and Local Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Cheap Roses for Sale | A Dozen Roses Delivery | Buy Roses and Rose Bushes for Sale';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Flower Delivery Atlanta | Cheap Atlanta Flowers Delivery from Atlanta Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY ATLANTA';
		...
		$head_prm1 = 'Flower Delivery Baltimore | Cheap Baltimore Flowers Delivery from Baltimore Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY BALTIMORE';
		...
		$head_prm1 = 'Flower Delivery Boston | Cheap Boston Flowers Delivery from Boston Florists and Flower Shops  ';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY BOSTON';
		$page_title = '';
		$meta_description = '';
		$meta_keywords = '';
	} elseif ($header_page_id == '21') { // CHICAGO
		$page_content = 'chicago_content.php';
		$head_prm1 = 'Flower Delivery Chicago | Cheap Chicago Flowers Delivery from Chicago Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY CHICAGO';
		...
		$head_prm1 = 'Flower Delivery Dallas | Cheap Dallas Flowers Delivery from Dallas Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY DALLAS';
		...
		$head_prm1 = 'Flower Delivery Denver | Cheap Denver Flowers Delivery from Denver Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY DENVER';
		...
		$head_prm1 = 'Flower Delivery Houston | Cheap Houston Flowers Delivery from Houston Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY HOUSTON';
		...
		$head_prm1 = 'Flower Delivery LA | Cheap Los Angeles Flowers Delivery from LA Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY LOS ANGELES';
		...
		$head_prm1 = 'Flower Delivery Minneapolis | Cheap Minneapolis Flowers Delivery from Minneapolis Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY LOS ANGELES';
		...
		$head_prm1 = 'Flower Delivery NYC | Flowers NYC | New York Flowers Delivery from Flower District NYC & Florist NYC';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY NYC';
		...
		$head_prm1 = 'Flower Delivery Pittsburgh | Cheap Pittsburgh Flowers Delivery from Pittsburgh Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY PITTSBURGH';
		...
		$head_prm1 = 'Flower Delivery San Diego | Cheap San Diego Flowers Delivery from San Diego Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY SAN DIEGO';
		...
		$head_prm1 = 'Flower Delivery San Francisco | Flowers San Francisco from San Francisco Florists and San Francisco Flower Mart';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		...
		$head_prm1 = 'Flower Delivery Seattle | Cheap Seattle Flowers Delivery from Seattle Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY SEATTLE';
		...
		$head_prm1 = 'Flower Delivery St Louis | Cheap St Louis Flowers Delivery from St Louis Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY ST LOUIS';
		...
		$head_prm1 = 'Flower Delivery Tulsa | Cheap Tulsa Flowers Delivery from Tulsa Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY **';
		$head_prm4 = 'FLOWER DELIVERY TULSA';
		...
		$head_prm1 = 'Flower to Canada | Send Flowers to Canada from USA';
		$head_prm2 = 'SEND';
		$head_prm3 = 'INTERNATIONAL **';
		$head_prm4 = 'FLOWERS TO CANADA';
		$page_title = 'FlowerWyz Flower to Canada | Send Flowers to Canada from USA';
		$meta_description = 'FlowerWyz Flower to Canada - Sending Flowers to Canada has never been easier. Send Flowers to Canada from USA anyday and everyday. Call us Today!';
		$meta_keywords = 'send flowers to Canada, flowers to Canada, flower to Canada, sending flowers to Canada, send flowers to Canada from usa, send flowers Canada, send flower to Canada, sending flowers to Canada from usa, send flowers online Canada, how to send flowers to Canada, send flowers to Canada from usa online, how to send flowers to Canada from usa, sending flower to Canada';
		...
		$head_prm1 = 'Floral Arrangements | Floral Delivery from Online Florists and Floral Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		$head_prm4 = 'FLORAL ARRANGEMENTS';
		$page_title = 'FlowerWyz Floral Arrangements | Floral Delivery from Online Florists and Floral Shops';
		$meta_description = 'Looking for Cheap Floral Arrangements? Check out FlowerWyz for Floral Delivery from Online Florists and Floral Shops. Accredited Florist Supplies of all kinds. Call us Today!';
		$meta_keywords = 'florist, floral, florists, floral arrangements, floral delivery, online florist, floral shop, florist supplies, florest, christmas floral arrangements, faux floral arrangements, florist delivery, online florists, florist shop, floral arrangement, how to make floral arrangements';
	} elseif ($header_page_id == '41') { //PLANTS
		$page_content = 'plant_content.php';
		$head_prm1 = 'Plant Delivery | Send a Plant and Orchid Delivery | Send Plants Delivered';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		$head_prm4 = 'PLANT DELIVERY';
		$page_title = 'FlowerWyz Plant Delivery | Send a Plant as Gift | Send House Plant Gifts';
		$meta_description = 'Looking for The Best Cheap Plant Delivery Service? Send a Plant as Gift With FlowerWyz Delivery Service. Send House Plant Gifts Anywhere. Plants Delivered on time every time. Call us Today!';
		$meta_keywords = 'plant delivery,send a plant,Send Plants as Gifts,Send a Plant as Gift,Gift Plants,Gift Plant,Plant Gifts,Plant Gift,plants delivered,send plants,plant delivered,send plant,plant delivery online,online plant delivery,Floor Plant Delivery,House Plant Delivery';
		...
		$head_prm1 = 'Wedding Flowers Online | Wedding Bouquets | Bridal Bouquets | Flowers for Weddings Flower Arrangements';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		...
		$head_prm1 = 'Flower Delivery Montreal | Cheap Montreal Flowers Delivery from Montreal Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		$head_prm4 = 'FLOWER DELIVERY MONTREAL';
		...
		$head_prm1 = 'Flower Delivery Toronto | Cheap Toronto Flowers Delivery from Toronto Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		$head_prm4 = 'FLOWER DELIVERY TORONTO';
		...
		$head_prm1 = 'Flower Delivery Quebec | Cheap Quebec Flowers Delivery from Quebec Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		$head_prm4 = 'FLOWER DELIVERY QUEBEC';
		...
		$head_prm1 = 'Flower Delivery Halifax | Cheap Halifax Flowers Delivery from Halifax Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		$head_prm4 = 'FLOWER DELIVERY HALIFAX';
		...
		$head_prm1 = 'Flower Delivery Hamilton | Cheap Hamilton Flowers Delivery from Hamilton Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		$head_prm4 = 'FLOWER DELIVERY HAMILTON';
		...
		$head_prm1 = 'Flower Delivery Ottawa | Cheap Ottawa Flowers Delivery from Ottawa Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		$head_prm4 = 'FLOWER DELIVERY OTTAWA';
		...
		$head_prm1 = 'Flower Delivery Portland | Cheap Portland Flowers Delivery from Portland Florists and Flower Shops';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		$head_prm4 = 'FLOWER DELIVERY PORTLAND';
		...
		$head_prm1 = 'Cheap Centerpiece Ideas | Flower Centerpieces | Dining Table Centerpieces | Floating Candle Centerpieces Ideas';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		...
		$head_prm1 = 'Cheap Funeral Casket Sprays and Casket Flowers | Inside Casket Flowers | Funeral Flowers For Top Of Casket';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		...
		$head_prm1 = 'Cheap Funeral Plants | Plants For Funerals | Popular Funeral Plants | Common Funeral Plants';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		...
		$head_prm1 = 'Cheap Funeral Wreaths | Wreath Of Flowers | Wreaths For Funerals Designs | Flower Wreaths For Doors';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		...
		$head_prm1 = 'Cheap Funeral Baskets | Bereavement Gift Baskets | Funeral Gift Baskets | Funeral Gifts';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
		...
		$head_prm1 = 'Love Flowers | Romantic Flowers | Best Flowers For You Flowers of Love | Romantic Flower Arrangements';
		$head_prm2 = 'SEND';
		$head_prm3 = 'SAME DAY ** ';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
		...
		<link rel="stylesheet" href="<?= $vpath ?>bootstrap/css/bootstrap-theme.min.css" />
		<link rel="stylesheet" href="<?= $vpath ?>css/page-layout.css" />
    </head>
    <body>