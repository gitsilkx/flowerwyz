...
$keywords = array('ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ', 'ABC KLM XYZ');
                ...
                <tbody>
                    ...
                    if (isset($products) && count($products) > 0):
                        ...
                        <tr class="pagination_area">
                            <td align="center" colspan="4" height="25"><?= paging($total, $num_records_per_page, $parama, "paging"); ?></td>
                        </tr>
                        <?php
                    else:
