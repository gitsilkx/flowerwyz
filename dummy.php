        ...
        <div class="Content" id="section">
            ...
            <div class="filterPan">  
                <ul class="listing">
                    ...
                    <li class="bt40-60"><a href="<?= $vpath ?>categories.php?category=bt40-60">UNDER $60</a></li>
                    <li class="bt60-80"><a href="<?= $vpath ?>categories.php?category=bt60-80">$60 - $80</a></li>
                    <li class="bt80-100"><a href="<?= $vpath ?>categories.php?category=bt80-100">$80 - $100</a></li>
                    <li class="o100"><a href="<?= $vpath ?>categories.php?category=o100">OVER $100</a></li>

                </ul>
                <form action="" method="get">
                    <div style="margin:10px 14px 0 0;float: right;">
                                ...
                                */
                                ...
                                <td>
                                    ...
                                    <div class="ProductPriceRating">
                                        <em><?php echo substr($product['name'],0,29); ?></em>
