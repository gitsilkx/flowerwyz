<?php
    ...
    class Lead
	{
		...
		function run()
		{
			...
			//Input
                        // Delivery Date must be within 30 days of current date or function or a date error will result

           $strSoapUsername = "123456";  //Your Soap username
            $strSoapPassword = "abcd";      //Your Soap password
			$arrRecipient = array("address1"=>"10 Main St.","address2"=>"","city"=>"New York City","country"=>"US","email"=>"test@test.com","institution"=>"","name"=>"Jane Smith","phone"=>"555-555-5555","state"=>"NY","zip"=>"10021");
			$arrCustomer = array("address1"=>"20 Main St.","address2"=>"","city"=>"New York City","country"=>"US","email"=>"test@test.com","institution"=>"Customer Institution","name"=>"John Smith","phone"=>"555-555-5555","state"=>"NY","zip"=>"10019");
			...
			$deliveryDate =  "2015-06-15T05:00:00.000Z"; //you can get this value from getDeliveryDates() call... the value must be dateTime format eg: 2011-01-15T05:00:00.000Z
			$affiliateServiceCharge = "0";
			$affiliateTax = "0";
			$orderTotal = "72.94"; // You can get this value from getTotal() call.... $this->arrTotal['orderTotal'];
			$subAffiliateID = 0;
			$arrProducts = array (
			  0=>
			  array (
        ...
        echo 'tot='.$orderTotal;
        echo 'Ip='.$customerIP;
        echo 'specialInstructions='.$specialInstructions;
        echo 'deliveryDate='.$deliveryDate;
        echo 'affiliateTax='.$affiliateTax;
       echo '</p>';
       die;
			...
			if($this->strSoapServerError == "") {
				//Output
				var_dump($this->arrProducts);
				var_dump($this->arrDates);
				var_dump($this->arrTotal);
				var_dump($this->arrOrder);
				var_dump($this->arrTickets);
			} else {
				//Print Error Message
				echo $this->strSoapServerError;
			}
