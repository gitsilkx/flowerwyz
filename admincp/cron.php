...
$message = "*********************** CRON STARTS [".$start_time."] ***********************<\n><\n>";
$message1 ="";
$message12="";
...
$message .= "STEP:1 [TAKE INITIAL COUNTS]<\n><\n>";
   ...
   // $mailto = 'flowerwyz@gmail.com';
	...
	$mpdf->Output("../uploads/".$pdf_name);
       ...
       // htmlentities($subject);
        $message = htmlentities($message.$message1.$message12);
        ...
        //$message = htmlspecialchars($message.$message1.$message12);
         ...
         //echo "INSERT INTO " . $prev."cron (`report1`, `report2`, `report3`, `cron_date`) VALUES ('".$pdf_name."', '".$addedFileName."', '".$deletedFileName."', '".$date."'";
         //die;
         mysql_query("INSERT INTO " . $prev."cron (`report1`, `report2`, `report3`, `cron_date`) VALUES ('".$pdf_name."', '".$addedFileName."', '".$deletedFileName."', '".$date."')");
    $msg="<font face='verdana' size='1' color='#ffffff'><b>Update Successful.</b></font>"; 
    echo"<script>window.location.href='cron.list.php?menuid=138&menupid=117';</script>";
   else:
