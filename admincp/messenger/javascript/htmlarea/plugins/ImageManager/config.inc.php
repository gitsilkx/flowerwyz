<?php
if((!defined("IM_INCLUDED")) || (!IM_INCLUDED)) {
	exit;
}
 ...
 * @version $Id: config.inc.php 107 2007-03-25 19:49:18Z matt.simpson $
...
*/
$IMConfig['base_dir'] = $_SESSION["config"][PREF_PUBLIC_PATH]."images/";
...
*/
$IMConfig['base_url'] = $_SESSION["config"][PREF_PUBLIC_URL]."images/";
