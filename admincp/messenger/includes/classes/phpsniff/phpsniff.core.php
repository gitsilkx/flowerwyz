<?php
/*******************************************************************************
	$Id: phpsniff.core.php 107 2007-03-25 19:49:18Z matt.simpson $
...
{   // initialize some vars
    ...
    function _get_ip ()
    {
        $this->_set_browser('ip', $_SERVER["REMOTE_ADDR"]);
    }
    ...
    {   global $HTTP_COOKIE_VARS;
        ...
        {   $fp = @fopen($this->_temp_file_path.$this->property('ip'),'r');
            ...
            {   $fp = @fopen($this->_temp_file_path.$this->property('ip'),'a');
                ...
                $script_path = $_SERVER['PATH_INFO'] ? $_SERVER['PATH_INFO'] : $_SERVER['SCRIPT_NAME'];
