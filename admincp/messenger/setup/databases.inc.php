...
/*
	...
	$Id: databases.inc.php 107 2007-03-25 19:49:18Z matt.simpson $
*/
...
CREATE TABLE `%TABLES_PREFIX%cdata` (`cdata_id` int(12) NOT NULL auto_increment, `user_id` int(12) NOT NULL default '0', `cfield_id` int(12) NOT NULL default '0', `value` longtext NOT NULL, PRIMARY KEY (`cdata_id`)) TYPE=MyISAM AUTO_INCREMENT=1;
CREATE TABLE `%TABLES_PREFIX%cfields` (`cfields_id` int(12) NOT NULL auto_increment, `field_type` varchar(16) NOT NULL default '', `field_options` longtext, `field_sname` varchar(16) default NULL, `field_lname` varchar(64) default NULL, `field_length` int(12) default '0', `field_req` int(1) NOT NULL default '0', `field_order` int(3) NOT NULL default '0', PRIMARY KEY (`cfields_id`), UNIQUE KEY `field_sname` (`field_sname`)) TYPE=MyISAM AUTO_INCREMENT=1;
...
CREATE TABLE `%TABLES_PREFIX%groups` (`groups_id` int(12) NOT NULL auto_increment, `group_name` varchar(64) NOT NULL default '', `group_parent` int(12) NOT NULL default '0', `permit_login` enum('true','false') NOT NULL default 'false', PRIMARY KEY (`groups_id`)) TYPE=MyISAM AUTO_INCREMENT=1;
CREATE TABLE `%TABLES_PREFIX%messages` (`message_id` int(12) NOT NULL auto_increment, `message_date` bigint(64) NOT NULL default '0', `message_title` varchar(255) NOT NULL default '', `message_subject` varchar(255) NOT NULL default '(no subject)', `message_from` text NOT NULL, `message_reply` text NOT NULL, `message_priority` int(1) NOT NULL default '0', `text_message` longtext NOT NULL, `text_template` int(12) default NULL, `html_message` longtext NOT NULL, `html_template` int(12) default NULL, `attachments` text NOT NULL, PRIMARY KEY (`message_id`)) TYPE=MyISAM AUTO_INCREMENT=1;
CREATE TABLE `%TABLES_PREFIX%preferences` (`preference_id` int(12) NOT NULL auto_increment, `preference_value` text NOT NULL, PRIMARY KEY (`preference_id`)) TYPE=MyISAM AUTO_INCREMENT=53;
CREATE TABLE `%TABLES_PREFIX%queue` (`queue_id` int(12) NOT NULL auto_increment, `message_id` int(12) NOT NULL default '0', `date` bigint(64) NOT NULL default '0', `touch` bigint(64) NOT NULL default '0', `target` text NOT NULL, `progress` int(12) NOT NULL default '0', `total` int(12) NOT NULL default '0', `status` varchar(25) NOT NULL default '', PRIMARY KEY (`queue_id`), KEY `date` (`date`)) TYPE=MyISAM AUTO_INCREMENT=1;
CREATE TABLE `%TABLES_PREFIX%sending` (`sending_id` int(12) NOT NULL auto_increment, `email_address` varchar(128) NOT NULL default '', `users_id` int(12) NOT NULL default '0', `queue_id` int(12) NOT NULL default '0', `sent` tinyint(1) NOT NULL default '0', PRIMARY KEY  (`sending_id`)) TYPE=MyISAM AUTO_INCREMENT=1;
CREATE TABLE `%TABLES_PREFIX%sessions` (`sesskey` VARCHAR( 64 ) NOT NULL DEFAULT '', `expiry` TIMESTAMP NOT NULL, `expireref` VARCHAR( 250 ) DEFAULT '', `created` TIMESTAMP NOT NULL, `modified` TIMESTAMP NOT NULL, `sessdata` LONGTEXT DEFAULT '', PRIMARY KEY (`sesskey`), INDEX sess2_expiry(`expiry`), INDEX sess2_expireref(`expireref`)) TYPE=MyISAM;
CREATE TABLE `%TABLES_PREFIX%templates` (`template_id` int(12) NOT NULL auto_increment, `template_name` varchar(64) NOT NULL default '', `template_type` varchar(4) NOT NULL default 'html', `template_description` text, `template_content` longtext NOT NULL, PRIMARY KEY (`template_id`)) TYPE=MyISAM AUTO_INCREMENT=1;
CREATE TABLE `%TABLES_PREFIX%users` (`users_id` int(12) NOT NULL auto_increment, `group_id` int(12) NOT NULL default '0', `signup_date` bigint(64) NOT NULL default '0', `firstname` varchar(32) default NULL, `lastname` varchar(64) default NULL, `email_address` varchar(128) NOT NULL default '', PRIMARY KEY (`users_id`)) TYPE=MyISAM AUTO_INCREMENT=1;
CREATE TABLE `%TABLES_PREFIX%user_updates` (`updates_id` int(12) NOT NULL auto_increment, `hash` varchar(32) NOT NULL default '', `date` bigint(64) NOT NULL default '0', `email_address` varchar(128) NOT NULL default '0', `completed` int(1) NOT NULL default '0', PRIMARY KEY (`updates_id`), UNIQUE KEY `hash` (`hash`)) TYPE=MyISAM AUTO_INCREMENT=1;
...
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (5, '2.1.0');
...
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (30, 'innovastudio');
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (31, 'no');
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (32, 'yes');
...
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (54, '0');
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (55, '0');
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (56, 'yes');
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (57, 'profile.php');
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (58, 'no');
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (59, 'no');
INSERT INTO `%TABLES_PREFIX%preferences` VALUES (60, '');
