<?php
/*
<language name="Italian" version="2.1.0">
	...
	<updated>19:48 10-13-2005</updated>
	<notes>Italian Language File</notes>
</language>
*/
$language_pack = array();

$language_pack["default_page_title"]					= "ListMessenger Mailing List Management System";
$language_pack["default_page_message"]					= "Si prega di visitare il nostro sito web principale per registrarsi o per essere cancellato da una o da più delle nostre mailing lists (liste di indirizzi e-mail).";
$language_pack["error_default_title"]					= "Errore nella Sua Richiesta ";
$language_pack["error_invalid_action"]					= "L’operazione richiesta non è valida, si prega di accertarsi di accedere correttamente a questo sistema attraverso un modulo di registrazione visionabile sul nostro sito web. Qualora necessitasse di ulteriore assistenza, si prega di contattare l’amministratore del sito web.";
...
$language_pack["error_subscribe_group_not_found"]		= "Una mailing list (lista di indirizzi e-mail) a cui Lei provava di registrarsi non esiste più in questo sistema. Qualora necessitasse di ulteriore assistenza, si prega di contattare l’amministratore del sito web.";
$language_pack["error_subscribe_email_exists"]			= "L’indirizzo e-mail da Lei fornito esiste già nella(e) mailing list(s) (lista/e di indirizzi e-mail) a cui Lei ha scelto di registrarsi. Qualora necessitasse di ulteriore assistenza, si prega di contattare l’amministratore del sito web.";
...
$language_pack["error_subscribe_invalid_email"]			= "L’indirizzo e-mail da Lei fornito non è riconosciuto come un indirizzo e-mail valido.";
$language_pack["error_subscribe_banned_email"]			= "In questo momento non è consentito registrarsi al sistema con l’indirizzo e-mail da Lei fornito.";
$language_pack["error_subscribe_banned_domain"]			= "Non è consentito iscriversi a questo sistema con la denominazione dell’indirizzo e-mail da Lei fornito.";
$language_pack["error_subscribe_invalid_domain"]		= "la denominazione dell’indirizzo e-mail da Lei fornito non sembra valido.";
$language_pack["error_subscribe_required_cfield"]		= "[cfield_name] questo è un campo obligatorio. Si prega di tornare indietro ed inserire questa informazione."; // Requires [cfield_name] variable in sentence.
...
$language_pack["success_subscribe_optin_message"]		= "La ringraziamo per l’interesse dimostrato nei confronti della nostra mailing list (lista di indirizzi e-mail). Riceverà un breve messaggio di conferma  mailing list (lista di indirizzi e-mail), si prega di riconfermare la Sua registrazione seguendo il link di conferma incluso in quell’e-mail.";
$language_pack["success_subscribe_title"]				= "Conferma di registrazione mailing list (lista di indirizzi e-mail)";
$language_pack["success_subscribe_message"]				= "La ringraziamo per l’interesse dimostrato nei confronti della nostra mailing list (lista di indirizzi e-mail). Il Suo indirizzo e-mail è stato aggiunto con successo alla nostra mailing list (lista di indirizzi e-mail) e su qesto riceverà i prossimi messaggi.";
...
$language_pack["error_unsubscribe_group_not_found"]		= "Una mailing list (lista di indirizzi e-mail) a cui Lei stava tentando di registrarsi non esiste più nel nostro sistema. Qualora necessitasse di ulteriore assistenza, si prega di contattare l’amministratore del sito web.";
...
$language_pack["error_unsubscribe_invalid_email"]		= "L’indirizzo e-mail da Lei fornito non è riconosciuto come un indirizzo e-mail valido.";
$language_pack["error_unsubscribe_failed_optout"]		= "Non possiamo purtroppo inviarLe un’e-mail di conferma di cancellazione a causa di un problema che stiamo affrontando. Si prega di contattare l’amministratore del sito web e di comunicargli che ha incontrato difficoltà durante questi tentativi.";
...
$language_pack["success_unsubscribe_message"]			= "Siamo spiacenti di constatare che Lei sta lasciando la nostra mailing list (lista di indirizzi e-mail). Il suo indirizzo e-mail è stato cancellato con successo dalla mailing list (lista di indirizzi e-mail) selezionata, ma se desidera registrarsi di nuovo lo può fare in ogni momento visitando il nostro sito web.";
...
$language_pack["error_confirm_completed"]				= "Appare che Lei abbia già confermato questa richiesta. Non serve nessun’altra operazione, grazie.";
...
$language_pack["page_help_answer_1_optin"]				= "La nostra mailing list (lista di indirizzi e-mail) attualmente richiede ai sottoscrittori di registrarsi 2 volte prima di considerarsi registrato a qualsiasi delle nostre mailing lists (liste di indirizzi e-mail). Ciò significa che Lei o qualcun’altro che utilizza il Suo indirizzo e-mail ha richiesto di essere aggiunto alla nostra mailing list (lista di indirizzi e-mail), allora il nostro sistema ha inviato un’e-mail di conferma che è stata confermata. Se Lei non conferma da solo la conferma di registrazione, è possible che il nostro amministratore di sito abbia aggiunto manualmente il Suo indirizzo e-mail al nostro sistema. I dettagli di questa transazione sono disponibili su richiesta, contattando per e-mail il nostro amministratore [abuse_address]."; // Requires [abuse_address] variable in sentence.
$language_pack["page_help_answer_1_no_optin"]			= "L’iscrizione alla nostra mailing list (lista di indirizzi e-mail) attualmente non richiede ai sottoscrittori di registrarsi 2 volte per essere inseriti in qualsiasi delle nostre mailing lists (liste di indirizzi e-mail). Ciò significa che Lei o qualcun’altro che utilizza il Suo indirizzo e-mail ha avuto accesso al Suo indirizzo e-mail nel nostro sistema e non era richiesto di confermare la Sua registrazione. I dettagli di questa transazione sono disponibili su richiesta, contattando per e-mail il nostro amministratore all’indirizzo [abuse_address]."; // Requires [abuse_address] variable in sentence.
$language_pack["page_help_question_2"]					= "Come posso cancellarmi da questa mailing list (lista di indirizzi e-mail)?";
$language_pack["page_help_answer_2_optout"]				= "Se desidera cancellarsi da una o più delle nostre mailing lists (liste di indirizzi e-mail), è libero di farlo, completando il modulo seguente. Una volta che Lei ha avuto accesso al Suo indirizzo e-mail e selezionato da quale o quali mailing list(s) (liste di indirizzi e-mail) vuole essere cancellato, Le verrà chiesto di confermare la cancellazione, seguendo il link contenuto in un’e-mail che riceverà.";
$language_pack["page_help_answer_2_no_optout"]			= "Se desidera cancellarsi da una o più delle nostre mailing lists (liste di indirizzi e-mail), è libero di farlo, completando il modulo seguente. Una volta che Lei ha inserito il Suo indirizzo e-mail e selezionato da quale o quali mailing list(s) (liste di indrizzi e-mail) vuole essere cancellato, sarà immediatamente cancellato dal nostro sistema.";
$language_pack["page_help_question_3"]					= "Cos’è questa e-mail che ho ricevuto?";
$language_pack["page_help_answer_3"]					= "Quest’area di aiuto della mailing list (lista di indirizzi e-mail) non può determinare il contenuto del message che ha ricevuto; tuttavia, se ha terminato questa pagina, allora il messaggio da Lei ricevuto è stato inviato usando il nostro programma di gestione della mailing list (lista di indirizzi e-mail). Se crede di avere ricevuto questo messaggio per errore, si prega di contattare l’amministratore all’indirizzo [abuse_address] e di informarlo della Sua situazione."; // Requires [abuse_address] variable in sentence.
...
$language_pack["page_archive_error_no_message"]			= "Il messaggio richiesto non può essere trovato nella nostra mailing list (lista di indirizzi e-mail). Si prega di tornare all’archivio.";
$language_pack["page_archive_error_no_messages"]		= "Attualmente non ci sono messaggi da visualizzare nell’archivio; si prega di riprovare più tardi.";
...
$language_pack["page_archive_view_missing_attachment"]	= "L’Allegato non è più disponibile";
...
-------------------------------------------------------------------
Questa e-mail stata spedita a [email] perché è stato registrato a uno o più nostre mailing list (lista di indirizzi e-mail). In qualsiasi momento se si vuole cancellare dalla nostra mailing list (lista di indirizzi e-mail) lo può fare visitando:
[unsubscribe_url]
UNSUBSCRIBEMSG;
...
Qualcuno (lei o l’amministratore della lista) ha richiesto che il suo indirizzo e-mail venga registrato su una o più delle nostre mailing list (lista di indirizzi e-mail).

Questa e-mail le è stata inviata per confermare la sua iscrizione alla nostra lista. Se vuole confermarla segua il seguente link:
[url]

Se lei non ha richiesto di essere iscritto a nessuna di queste mailing list (lista di indirizzi e-mail), ignori questa e-mail e non segua il link precedente. Se queste richieste persistono si può notificare l’illecito a:
[abuse_address].
...
Qualcuno (lei o l’amministratore della lista) ha richiesto che il suo indirizzo e-mail (lista di indirizzi e-mail) venga cancellato da una o più delle nostre mailing list.

Questa e-mail le è stata inviata per confermare la sua cancellazione al nostro sistema. Se vuole confermarla seguire il link seguente:
[url]

Se lei non ha richiesto di essere cancellato a nessuna di queste mailing list (lista di indirizzi e-mail), ignori questa e-mail e non segua il link precedente. Se queste richieste persistono si può notificare l’illecito a [abuse_address].
...
Questa e-mail è per informarla che c’è una nuova sottoscrizione ad una o più della sua ListMessenger mailing lists (lista di indirizzi e-mail).
...
-------------------------------------------------------------------
Lei sta ricevendo questo messaggio perchè l’avviso ‘sottoscrizione nuova’ è stato attivato nel pannello di controllo di ListMessenger. Se vuole disattivare gli avvisi, entri nella ListMessenger, cliccando Control Panel, End-User Preferences e cambia l’avviso ‘sottoscrizione nuova’ a disattivare.
...
Questa è una e-mail che informa che il seguente utente si è cancellato da una o più liste.
...
-------------------------------------------------------------------
Lei sta ricevendo questo messaggio perchè l’avviso ‘utente cancellato’ è stata attivato nel pannello di controllo di ListMessenger. Se vuole disattivare gli avvisi, entri nella ListMessenger, cliccando Control Panel, End-User Preferences e cambi avviso ‘utente cancellato’ a disattivare.
